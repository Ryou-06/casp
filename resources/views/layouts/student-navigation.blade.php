            ...
            <div class="px-4 space-y-2">
                ...
                <a href="{{ route('submissions.index') }}" 
                   ...
                   style="{{ request()->routeIs('submissions.*') 
                      ? 'background-color: #185FA5; color: white;' 
                      : 'color: #B5D4F4;' }}"
                   onmouseover="{{ !request()->routeIs('submissions.*') ? 'this.style.backgroundColor=\"#0C447C\"' : '' }}"
                   onmouseout="{{ !request()->routeIs('submissions.*') ? 'this.style.backgroundColor=\"transparent\"' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
