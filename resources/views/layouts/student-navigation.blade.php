        ...
        <nav class="flex-1 py-6">
            <div class="px-4 space-y-2">
                ...
                <a href="{{ route('student.dashboard') }}" 
                   ...
                   style="{{ request()->routeIs('student.dashboard') 
                      ? 'background-color: #185FA5; color: white;' 
                      : 'color: #B5D4F4;' }}"
                   onmouseover="{{ !request()->routeIs('student.dashboard') ? 'this.style.backgroundColor=\"#0C447C\"' : '' }}"
                   onmouseout="{{ !request()->routeIs('student.dashboard') ? 'this.style.backgroundColor=\"transparent\"' : '' }}">
                ...
                {{-- <a href="{{ route('student.classrooms.index') }}" 
                   class="flex items-center px-4 py-3 rounded-lg transition-colors duration-150"
                   style="{{ request()->routeIs('student.classrooms.*') 
                      ? 'background-color: #185FA5; color: white;' 
                      : 'color: #B5D4F4;' }}"
                   onmouseover="{{ !request()->routeIs('student.classrooms.*') ? 'this.style.backgroundColor=\"#0C447C\"' : '' }}"
                   onmouseout="{{ !request()->routeIs('student.classrooms.*') ? 'this.style.backgroundColor=\"transparent\"' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
