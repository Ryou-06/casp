        ...
        <nav class="flex-1 py-6">
            <div class="px-4 space-y-2">
                ...
                <a href="{{ route('student.dashboard') }}" 
                   class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 {{ request()->routeIs('student.dashboard') ? 'bg-purple-50 text-purple-600' : '' }}">
                ...
                <a href="{{ route('submissions.index') }}" 
                   class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 {{ request()->routeIs('submissions.*') ? 'bg-purple-50 text-purple-600' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
