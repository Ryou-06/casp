        ...
        <nav class="flex-1 py-6">
            <div class="px-4 space-y-2">
                ...
                <a href="{{ route('classrooms.index') }}" 
                   class="flex items-center px-4 py-3 rounded-lg transition-colors duration-150"
                   style="{{ request()->routeIs('classrooms.*') 
                      ? 'background-color: #185FA5; color: white;' 
                      : 'color: #B5D4F4;' }}"
                   onmouseover="{{ !request()->routeIs('classrooms.*') ? 'this.style.backgroundColor=\"#0C447C\"' : '' }}"
                   onmouseout="{{ !request()->routeIs('classrooms.*') ? 'this.style.backgroundColor=\"transparent\"' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('students.create') }}"
                   class="flex items-center px-4 py-3 rounded-lg transition-colors duration-150"
                   style="{{ request()->routeIs('students.*')
                      ? 'background-color: #185FA5; color: white;'
                      : 'color: #B5D4F4;' }}"
                   onmouseover="{{ !request()->routeIs('students.*') ? 'this.style.backgroundColor=\"#0C447C\"' : '' }}"
                   onmouseout="{{ !request()->routeIs('students.*') ? 'this.style.backgroundColor=\"transparent\"' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('classrooms.create') }}" 
                   ...
                   style="background-color: #0C447C;"
                   onmouseover="this.style.backgroundColor='#185FA5'"
                   onmouseout="this.style.backgroundColor='#0C447C'">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center px-4 py-2">
                ...
                <form method="POST" action="{{ route('logout') }}" class="ml-auto">
                    ...
                    <button type="button"
                            ...
                            onmouseout="this.style.color='#85B7EB'">
